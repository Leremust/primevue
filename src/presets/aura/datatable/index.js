  ...
  column: {
    headerCell: ({ context, props }) => ({
          class: [
            ...
            {
              "overflow-hidden whitespace-nowrap border-y bg-clip-padding": context == null ? void 0 : context.resizable
              // Resizable
            }
          ]
      }),
    ...
    filterOverlay: {
      class: ["flex flex-col gap-2", "absolute top-0 left-0", "border-0 dark:border", "rounded-md", "shadow-md", "min-w-[12.5rem]", "bg-surface-0 dark:bg-surface-900", "text-surface-800 dark:text-white/80", "dark:border-surface-700"]
    },
    ...
    filterOperator: {
      class: ["rounded-t-md", "text-surface-700 dark:text-white/80", "bg-surface-0 dark:bg-surface-700", "[&>[data-pc-name=pcfilteroperatordropdown]]:w-full"]
    },
    filter: ({ instance }) => ({
